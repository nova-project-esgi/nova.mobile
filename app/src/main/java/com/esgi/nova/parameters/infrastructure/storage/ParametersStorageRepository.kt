...
class ParametersStorageRepository @Inject constructor(context: Context): BaseStorageRepository(context) {
    ...
    fun get(): IParameters{
        return Parameters(
            isDarkMode = preference.getBoolean(PreferenceConstants.Parameters.IsDarkModeKey, false),
