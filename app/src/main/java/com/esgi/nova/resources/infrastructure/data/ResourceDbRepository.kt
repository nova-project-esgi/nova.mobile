...
class ResourceDbRepository @Inject constructor(override val dao: ResourceDAO) :
    BaseRepository<UUID, ResourceEntity, IResource>() {

    override fun toEntities(entities: Collection<IResource>): Collection<ResourceEntity> =
