...
data class LeaderBoardGameView (
    ...
    data class GameResourceView(
        ...
        override val name: String) : ILeaderBoardGameView.IGameResourceView

    data class UserRecapped(override val id: UUID, override val email: String, override val role: Role, override val username: String) :
